       ...
       <div class="container pt-4 mx-auto">
            ...
            <h3 class="d-flex justify-content-center">Add Category</h3>
              <div class="col-md-7 mx-auto col-lg-8 mt-4">
                ...
                <form class="needs-validation" novalidate="" action="<?php echo $this->getUrl('save');?>" method="post">
                  <div class="row g-3">
                  ...
                  <button class="btn waves-effect waves-light bg-dark text-white" type="submit" name="save">Add Category
