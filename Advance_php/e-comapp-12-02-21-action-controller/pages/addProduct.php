              ...
              <div class="col-md-7 mx-auto col-lg-8 mt-4">
                ...
                <form class="needs-validation" novalidate="">
                  <div class="row g-3">
                    ...
                    <input id="quantity" name="qty" type="number" min="1" max="10" name="qty" class="validate" placeholder="Quantity" >
                  ...
                  <button class="btn waves-effect waves-light bg-dark text-white" type="submit" name="addProduct">Add Product
