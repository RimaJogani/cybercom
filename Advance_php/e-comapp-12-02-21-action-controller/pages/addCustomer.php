       ...
       <div class="container pt-4 mx-auto">
            ...
            <h3 class="d-flex justify-content-center">Add Customer</h3>
              <div class="col-md-7 mx-auto col-lg-8 mt-4">
                ...
                <form class="needs-validation" novalidate="" action="./addCustomer.php" method="post">
                  <div class="row g-3">
                    <div class="col-sm-6">
                  ...
                  <button class="btn waves-effect waves-light bg-dark text-white" type="submit" name="addCustomer">Add Customer
